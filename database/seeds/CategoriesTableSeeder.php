...
class CategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::create(['title' => 'DVD & Blu-Ray', 'parent_id' => '0', 'slug' => 'dvd-blu-ray', 'ru_title' => 'DVD & Blu-Ray']);
        Category::create(['title' => 'DVD', 'parent_id' => '5', 'slug' => 'dvd', 'ru_title' => 'DVD диск']);
        Category::create(['title' => 'Blu Ray', 'parent_id' => '5', 'slug' => 'blu-ray', 'ru_title' => 'Blu Ray диск']);
    }
}
